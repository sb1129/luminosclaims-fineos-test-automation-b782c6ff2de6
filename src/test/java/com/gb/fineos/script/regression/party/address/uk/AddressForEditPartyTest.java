package com.gb.fineos.script.regression.party.address.uk;
...
public class AddressForEditPartyTest extends BaseTest {
    ...
    public void inputAddressMandatoryFieldsOnly(final Map<String, String> testData) {
        doTest("inputAddressMandatoryFieldsOnly", "Verify Incident Address Fields on UK and NZ create Party", testData, tc -> {
    ...
    public void inputAllAddressFields(final Map<String, String> testData) {
        doTest("inputAllAddressFields", "Verify Incident Address All Fields on UK and NZ", testData, tc -> {
            navigateToAddressForCreateParty(tc);
    ...
    public void verifyAddressValidationError(final Map<String, String> testData) {
        doTest("verifyAddressValidationError", "Verify Incident Address All Fields on UK and NZ", testData, tc -> {
            navigateToAddressForCreateParty(tc);
